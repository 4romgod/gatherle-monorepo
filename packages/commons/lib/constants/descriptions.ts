...
export const EVENT_MOMENT_DESCRIPTIONS = {
  ...
  IMAGE_DISPLAY_MODE_ENUM: 'How an uploaded image moment should be framed inside the vertical moment viewer.',
  ...
  IMAGE_DISPLAY_MODE: 'Preferred layout for image moments inside the 9:16 viewer frame.',
