    ...
    new Rule(this, 'S3ObjectCreatedRule', {
      ...
      eventPattern: {
        ...
        detail: {
          ...
          object: {
            key: [
              { wildcard: `${props.applicationStage.toLowerCase()}/event-moments/*.mp4` },
              { wildcard: `${props.applicationStage.toLowerCase()}/event-moments/*.mov` },
              { wildcard: `${props.applicationStage.toLowerCase()}/event-moments/*.webm` },
              { wildcard: `${props.applicationStage.toLowerCase()}/event-moments/*.avi` },
              { wildcard: `${props.applicationStage.toLowerCase()}/event-moments/*.mkv` },
            ],
          },
        },
      },
