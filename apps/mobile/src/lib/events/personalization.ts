...
function scoreInterestMatch(event: MobileEventOccurrence, interestKeys: Set<string>): number {
...
function scoreLocationMatch(event: MobileEventOccurrence, location: LocationLike | null | undefined): number {
...
function scoreSupportSignals(event: MobileEventOccurrence): number {
...
function getStableStartTime(event: MobileEventOccurrence): number {
