...
export const buildWeeklyOccurrenceFixture = (): WeeklyOccurrenceFixture => {
  ...
  return {
    firstStartAt,
    firstEndAt,
    weeklyDurationMinutes: Math.round((firstEndAt.getTime() - firstStartAt.getTime()) / MINUTE_MS),
    secondStartAt,
    secondEndAt,
    thirdStartAt,
    thirdEndAt,
    singleStartAt,
    singleEndAt,
    singleDurationMinutes: Math.round((singleEndAt.getTime() - singleStartAt.getTime()) / MINUTE_MS),
    ...
    weeklyRuleCount2: 'FREQ=WEEKLY;COUNT=2;BYDAY=WE',
    weeklyRuleCount3: 'FREQ=WEEKLY;COUNT=3;BYDAY=WE',
    singleRuleCount1: 'FREQ=DAILY;COUNT=1',
  };
};
